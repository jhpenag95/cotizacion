                ...
                <div class="container">
                    <form class="row g-3 needs-validation" action="" method="post" novalidate>
                        ...
                        <div class="col-md-5 position-relative">
                            ...
                            <input type="number" class="form-control" name="telefono" id="validationTooltip02" placeholder="Télefono del proveedor" value="<?php echo $telefono ?>">
                        </div>
                        <div class="col-md-4 position-relative">
                            <label for="validationTooltipUsername" class="form-label">Dirección</label>
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" name="direccion" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="Dirección proveedor" value="<?php echo $direccion ?>">
                            </div>
                        </div>
                        <div class="col-12">
